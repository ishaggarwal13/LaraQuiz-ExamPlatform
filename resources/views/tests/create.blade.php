...
@section('content')
    ...
    <form method="POST" action="{{ route('tests.store') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    @foreach($question->options as $option)
                                        ...
                                        <label class="radio-inline">
                                            <input type="radio" name="answers[{{ $question->id }}]" value="{{ $option->id }}" class="radio-inline">
                                            {{ $option->option }}
                                        </label>
                                    @endforeach
                                </div>
        ...
        <!-- Submit button -->
        <button type="submit" class="btn btn-danger">@lang('quickadmin.submit_quiz')</button>
    </form>
@stop
